...
import { getPanel, getTask, listMessagesForTask } from '../../graphql/queries';
...
class TaskMessages extends React.Component {
  ...
  render() {
    return (
      <Messages task={this.props.task} panel={this.props.panel} messages={this.state.messages} onSend={this.onSend.bind(this)} navigation={this.props.navigation} />
    );
  }
}
